...
class Node:
    ...
    def expand(self, problem):
        ...
        successors = []
        for (act, next) in problem.successor(self.state):
            new_node = Node(next, self, act, problem.path_cost(self.path_cost, self.state, act, next))
...
def branch_and_bound_heuristic_search(problem):
    """Search the nodes using the Branch and Bound algorithm with heuristic"""
    return graph_search(problem, BnBHeuristicQueue(problem))
